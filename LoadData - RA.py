...
# Data Path
file1 = 'F:/Geo/Data/Real/aphy_real_Oct.xlsx'
file2 = 'F:/Geo/Data/Real/Rrs_real_Oct.xlsx'
...
#     plt.hist(df2_clean.iloc[:, col], bins=100, alpha=0.7, color='blue')
#     plt.xlabel('$a_{ph}$ values')  # 修改 xlabel
...
df1_clean.to_csv('F:/Geo/Data/Real/aphy_RA_HICO_Oct.csv', index=False, header=False, float_format='%.5f')
df2_clean.to_csv('F:/Geo/Data/Real/Rrs_RA_HICO_Oct.csv', index=False, header=False, float_format='%.5f')
